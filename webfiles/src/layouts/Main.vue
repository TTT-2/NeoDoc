<template>
    <div class="container bg-background text-on-background transition duration-500">
        ...
        <nav class="text-on-background font-bold my-8" aria-label="Breadcrumb">
